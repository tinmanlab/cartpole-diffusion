...
server.listen(8123,"127.0.0.1",async()=>{
  try{
    ...
    if(!globalThis.DiffusionCompare||typeof globalThis.DiffusionCompare.runToEnd!=="function")throw new Error("diffusion compare api missing");
