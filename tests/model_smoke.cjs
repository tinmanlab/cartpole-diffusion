...
server.listen(8123,"127.0.0.1",async()=>{
  try{
    ...
    for(const id of ["observation","denoiseStages","execution","ladder","inspector","runBtn","resetBtn","pushL","pushR","guideBtn","guideControls","guidePrev","guideNext","guideExit","guideStep","guideExplain","reobserveCompare","denoiseTimeline","denoiseOneStep"])if(!html.includes('id="'+id+'"'))throw new Error("missing "+id);
