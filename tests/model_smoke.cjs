...
server.listen(8123,"127.0.0.1",async()=>{
  try{
    ...
    if(!globalThis.ControlLoopViz||typeof globalThis.ControlLoopViz.renderStages!=="function"||typeof globalThis.ControlLoopViz.renderObservation!=="function"||typeof globalThis.ControlLoopViz.renderExecution!=="function"||typeof globalThis.ControlLoopViz.renderStateDelta!=="function"||typeof globalThis.ControlLoopViz.renderDenoiseUpdate!=="function")throw new Error("control-loop viz api missing");

    const html=fs.readFileSync(path.join(root,"index.html"),"utf8");
    for(const id of ["observation","denoiseStages","execution","ladder","inspector","runBtn","resetBtn","pushL","pushR","guideBtn","guideControls","guidePrev","guideNext","guideExit","guideStep","guideExplain","reobserveCompare","denoiseOneStep"])if(!html.includes('id="'+id+'"'))throw new Error("missing "+id);
