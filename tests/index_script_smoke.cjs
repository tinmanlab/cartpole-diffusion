...
for(const required of ["app/control_loop_viz.js",'id="observation"','id="denoiseStages"','id="execution"','id="guideBtn"','id="guideStep"','id="guideNext"','id="guideExit"','id="reobserveCompare"','id="denoiseOneStep"',"1/6 · 관측","6/6 · 다시 관측","한 cycle 설명","관측 (Observe)","계획 (Plan) · Diffusion이 미래 force 16개 생성","실행 (Act) · 앞 4개 force만 적용"]){
