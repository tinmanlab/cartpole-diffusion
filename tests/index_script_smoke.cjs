...
for(const required of ["app/control_loop_viz.js","app/diffusion_compare.js",'id="plantCard"','id="tickLabel"','id="stepBtn"','id="observation"','id="denoiseStages"','id="execution"','id="guideBtn"','id="guideStep"','id="guideNext"','id="guideExit"','id="reobserveCompare"','id="denoiseTimeline"','id="denoiseOneStep"','id="conditioningCompare"','id="samplingCompare"','id="learnModeBtn"','id="replayModeBtn"','id="replayMode"','id="replayCards"','id="replaySlider"',"DETERMINISTIC REPLAY","same learned diffusion policy","Step 20 ms","1/6 · 관측","sampling diversity","6/6 · 다시 관측","한 cycle 설명","관측 (Observe)","계획 (Plan) · Diffusion이 미래 force 16개 생성","실행 (Act) · 앞 4개 force만 적용","0.32 s 미래","0.08 s 실행","receding horizon"]){
